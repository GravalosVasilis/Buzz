...
public class ThermometerGui {
    ...
    public void questionsMenuForThermometerGame() throws IOException {
        ...
        JLabel questionRemainForP1 = new JLabel(5-p1.getCorectA() + " questions remain for " + p1.getPlayer());
        questionRemainForP1.setForeground(Color.orange);
        questionRemainForP1.setFont(new Font("" ,Font.PLAIN , 20));
        questionPanel.add(questionRemainForP1);
        ...
        JLabel questionRemainForP2 = new JLabel(5-p2.getCorectA() + " questions remain for " + p2.getPlayer());
        questionRemainForP2.setForeground(Color.orange);
        questionRemainForP2.setFont(new Font("" ,Font.PLAIN , 20));
        questionPanelP2.add(questionRemainForP2);
