...
public class GuiBuzz {
     ...
     * @throws IOException ΣΕ ΠΕΡΙΠΤΩΣΗ ΠΟΥ ΔΕΝ ΒΡΕΘΕΙ ΤΟ ΑΡΧΕΙΟ ΤΩΝ ΕΡΩΤΗΣΕΩΝ
     */
     ...
     * @throws IOException ΣΕ ΠΕΡΙΠΤΩΣΗ ΠΟΥ ΔΕΝ ΒΡΕΘΕΙ ΤΟ ΑΡΧΕΙΟ ΤΩΝ ΕΡΩΤΗΣΕΩΝ
     * @throws InterruptedException ΧΡΗΣΙΜΟΠΟΙΕΙΤΕ ΓΙΑ ΤΙΣ ΕΣΚΕΜΜΕΝΕΣ ΚΑΘΥΣΤΕΡΗΣΕΙΣ
     */
    public void playGui() throws IOException, InterruptedException {
        ...
        //Ο ΑΡΙΘΜΟΣ ΤΩΝ ΓΥΡΩΝ ΠΟΥ ΘΑ ΠΑΙΧΤΟΥΝ
        for (int i=0; i<5; i++) {
            playOneRound();
    ...
    public void playOneRound() throws IOException, InterruptedException {
        ...
        String typeOfRound = logic.giveTypeOfRound1();
        firstPlayer.refreshA();
        if (playersNumber==2) {
            secondPlayer.refreshA();
            typeOfRound = logic.giveTypeOfRound2();
        }
            ...
            if (playersNumber == 1) {
                ...
                switch (typeOfRound) {
                    case "TrueAn":
                        ...
                        trueAnswerGui.questionsMenuForTrueAnswer(i+1);
                    ...
                    case "BetGame":
                        ...
                        betGameGui.questionsMenuForBetGame(i+1);
                    ...
                    case "Chronometer":
                        ...
                        chronometerGui.questionsMenuForChronometerGame(i+1);
                ...
                switch (typeOfRound) {
                    ...
                    case "BetGame":
                        ...
                        betGameForTwoPlayersGui.questionsMenuForBetGame2Players(i+1);
                    ...
                    case "FastAnser":
                        ...
                        fastAnswerGui.questionsMenuForFastAnswerGame(i+1);
     ...
     * ΟΛΟΚΛΗΡΩΘΟΥΝ ΟΛΟΙ ΟΙ ΓΥΡΟΙ(5). ΤΟ ΟΝΟΜΑ ΤΟΥ ΑΡΧΕΙΟΥ ΕΙΝΑΙ filename.txt
     * @throws IOException ΣΕ ΠΕΡΙΠΤΩΣΗ ΠΟΥ ΔΕΝ ΒΡΕΘΕΙ ΤΟ ΑΡΧΕΙΟ ΤΩΝ ΕΡΩΤΗΣΕΩΝ
     */
    public void makeTheArchive() throws IOException {
        ...
        try {
            ...
            myWriter.write(firstPlayer.getPlayer() + " " + firstPlayer.getPoints() + " " +winsP1);
            myWriter.write("\n");
            if (playersNumber==2){
                myWriter.write("\n");
                myWriter.write(secondPlayer.getPlayer() + " " + secondPlayer.getPoints() + " " +winsP2);
            }
            myWriter.close();
